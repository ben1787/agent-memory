...
Phrase the query the way the answer would phrase itself, not the way a question would. ✅ `"factor model nexus repository pattern"`  ❌ `"how do I add a factor model"`.
